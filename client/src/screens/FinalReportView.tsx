        ...
        <main className="results-layout">
            <section className="exam-sheet result-sheet final-report-sheet">
                ...
                <div className="final-report-actions">
                    <span>
                        {ownPlayer ? `${ownPlayer.nickname} 성적 확인 완료` : "성적 확인 완료"}
                    </span>
                    <button
                        className="leave-report-btn"
                        type="button"
                ...
                <div className="final-report-table">
                    ...
                    {players.map((player) => {
                        ...
                        return (
                            <div
                                key={player.id}
                                className={`final-report-row ${ownPlayer?.id === player.id ? "me" : ""}`}
                            >
                                ...
                                <span>
                                    {player.scoreBreakdown.solved}/{room.exam.problemCount}
                                </span>
                            </div>
                        );
                    })}
