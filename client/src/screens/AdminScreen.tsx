...
const uploadHeaderFileName = (fileName: string) =>
    fileName
...
export function AdminScreen() {
    ...
    const bodyCheck = useMemo(() => {
        ...
        if (
            ...
            (!Number.isInteger(Number(form.answer)) ||
                Number(form.answer) < 1 ||
                Number(form.answer) > choices.length)
        ) {
            return {
                ok: false as const,
                body: null,
    ...
    const examSettingsCheck = useMemo(() => {
        ...
        if (!examSettings.title.trim() || !examSettings.subtitle.trim())
        ...
        if (
            examSettings.releaseAt.trim() &&
            Number.isNaN(Date.parse(examSettings.releaseAt.trim()))
        )
    ...
    const createExam = async () => {
        ...
        setExams((current) =>
            [...current.filter((exam) => exam.id !== created.id), created].sort(
                (left, right) =>
    ...
    return (
        <main className="admin-shell">
            ...
            <AdminCampaignStats token={token} />
            ...
            <section className="admin-layout">
                    ...
                    <div className="admin-section-head">
                        ...
                        <div className="admin-section-actions">
                            ...
                            <button
                                ...
                                onClick={() => setNewExamOpen((current) => !current)}
                                aria-label="새 문제지"
                            >
                                <Plus size={16} />
                            </button>
                        ...
                        <section className="admin-new-exam">
                            ...
                            <label>
                                ...
                                <input
                                    value={newExam.id}
                                    onChange={(event) =>
                                        updateNewExam("id", makeSlug(event.target.value))
                                    }
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        updateNewExam("subtitle", event.target.value)
                                    }
                                />
                            </label>
                            <div className="admin-new-exam-row">
                                <label>
                                    ...
                                    <input
                                        ...
                                        onChange={(event) =>
                                            updateNewExam("timeLimitMin", event.target.value)
                                        }
                                        inputMode="numeric"
                                    />
                                </label>
                                <button
                                    ...
                                    onClick={() => updateNewExam("active", !newExam.active)}
                                >
                ...
                <section className="admin-problem-list">
                    <div className="admin-section-head">
                        ...
                        <strong>
                            {selectedExam ? (selectedExam.active ? "공개" : "비공개") : ""}
                        </strong>
                    </div>
                    {selectedExam && examSettings && (
                        <div className="admin-exam-quick-actions">
                            <button
                                ...
                                onClick={toggleSelectedExamActive}
                            >
                        ...
                        <section className="admin-exam-settings">
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        updateExamSettings("title", event.target.value)
                                    }
                                />
                            </label>
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        updateExamSettings("subtitle", event.target.value)
                                    }
                                />
                            </label>
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        updateExamSettings("timeLimitMin", event.target.value)
                                    }
                                    inputMode="numeric"
                                />
                            </label>
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        updateExamSettings("releaseAt", event.target.value)
                                    }
                                    placeholder="비워두면 즉시"
                                />
                            </label>
                            <button
                                ...
                                disabled={!examSettingsCheck.ok || !isExamSettingsDirty}
                            >
                                <Save size={16} /> 설정 저장
                            </button>
                        </section>
                    ...
                    <div className="admin-problem-nav">
                        ...
                        <button
                            ...
                            disabled={
                                !selectedExam ||
                                selectedProblemIndex >= selectedExam.problems.length - 1
                            }
                        >
                ...
                <section className="admin-editor">
                    ...
                    {form && (
                        <>
                            <div className="admin-edit-state-strip" aria-label="편집 상태">
                                ...
                                <span className={canSave ? "valid" : "invalid"}>
                                    <b>검증</b>
                                    {canSave
                                        ? "저장 가능"
                                        : bodyCheck.error || pointValueCheck.error || "필수값 확인"}
                                </span>
                            ...
                            <div className="admin-editor-grid">
                                    ...
                                    >
                                        {(["choice", "short"] as const).map((answerKind) => (
                                            <button
                                                ...
                                                type="button"
                                                className={
                                                    form.answerKind === answerKind ? "selected" : ""
                                                }
                                                onClick={() => updateAnswerKind(answerKind)}
                                            >
                                ...
                                <label
                                    className={
                                        form.answerKind === "choice" ? "admin-choice-answer" : ""
                                    }
                                >
                                    <span>정답</span>
                                    {form.answerKind === "choice" ? (
                                        <div
                                            className="admin-answer-picks"
                                            role="group"
                                            aria-label="객관식 정답"
                                        >
                                            {choicesForAnswer.map((_, index) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        type="button"
                                                        className={
                                                            form.answer === answer ? "selected" : ""
                                                        }
                                                        onClick={() => updateForm("answer", answer)}
                                                    >
                                                        {answer}
                                                    </button>
                                                );
                                ...
                                <div className="admin-field">
                                    <span>난도</span>
                                    <div
                                        className="admin-difficulty-picks"
                                        role="group"
                                        aria-label="난도"
                                    >
                                        {[1, 2, 3, 4, 5].map((difficulty) => (
                                            <button
                                                ...
                                                type="button"
                                                className={
                                                    form.difficulty === difficulty ? "selected" : ""
                                                }
                                ...
                                <label>
                                    ...
                                    <input
                                        ...
                                        onChange={(event) =>
                                            updateForm("pointValue", event.target.value)
                                        }
                                        placeholder="auto"
                                    />
                                </label>
                            ...
                            <div
                                className={`admin-markup-editor ${assetDragging || uploadingAsset ? "drag-active" : ""}`}
                            >
                                <div className="admin-body-toolrow">
                                    ...
                                    <div>
                                        <button
                                            type="button"
                                            className="secondary-btn"
                                            onClick={() => insertBodyMarkup("::math x^2+1")}
                                        >
                                            수식
                                        </button>
                                        <button
                                            ...
                                            className="secondary-btn"
                                            onClick={() =>
                                                insertBodyMarkup("::svg diagrams/graph.svg | 도표")
                                            }
                                        >
                                            도표
                                        </button>
                                        <button
                                            type="button"
                                            className="secondary-btn"
                                            onClick={() => insertBodyMarkup("::note 조건")}
                                        >
                                            조건
                                        </button>
                                        {form.answerKind === "choice" && (
                                            <button
                                                type="button"
                                                className="secondary-btn"
                                                onClick={() => insertBodyMarkup("::choice 1")}
                                            >
                                                선택지
                                            </button>
                                        )}
                                ...
                                <textarea
                                    ...
                                    onChange={(event) =>
                                        updateForm("bodyMarkup", event.target.value)
                                    }
                            ...
                            {(!bodyCheck.ok || !pointValueCheck.ok || uploadingAsset) && (
                                <div className="admin-validation-strip">
                                    {!bodyCheck.ok && (
                                        <span className="invalid">{bodyCheck.error}</span>
                                    )}
                                    {!pointValueCheck.ok && (
                                        <span className="invalid">{pointValueCheck.error}</span>
                                    )}
                    ...
                    {!form && selectedExam && (
                        <p className="admin-empty-copy">
                            아직 문항이 없습니다. 왼쪽 문항 추가 버튼으로 첫 문항을 만들 수
                            있습니다.
                        </p>
                    )}
                    ...
                    {previewProblem && (
                        <div className="admin-preview-paper">
                            <div className="admin-preview-head">
                                ...
                                <strong>
                                    {previewProblem.answerKind === "choice" ? "객관식" : "단답형"} ·
                                    정답 {form?.answer ?? ""}
                                </strong>
                            </div>
