...
export function AppLoading({
  ...
  needsReferralGate,
  referralCode,
  setReferralGatePassed,
  exitReferralGate
}: {
  inviteCode: string;
  needsReferralGate: boolean;
  referralCode: string;
  setReferralGatePassed: (passed: boolean) => void;
    ...
    <div className="app-shell">
      {props.needsReferralGate && (
        <ReferralSchoolGate
          ...
          onVerified={() => props.setReferralGatePassed(true)}
      ...
      {props.screen === "home" && !props.needsReferralGate && (
        <EventHomeScreen
          ...
          registrationInviteCode={props.registrationInviteCode}
          setRegistrationInviteCode={props.setRegistrationInviteCode}
      ...
      {props.screen === "arena" && props.room && props.ownPlayer && (
        <ArenaScreen room={props.room} ownPlayer={props.ownPlayer} onLeave={props.leaveRoom} />
      )}

      {props.screen === "results" && props.room && (
        <ResultsScreen room={props.room} ownPlayer={props.ownPlayer} onLeave={props.leaveRoom} />
      )}
    </div>
  );
}
