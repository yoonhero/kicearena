...
const cacheKey = (latex: string, displayMode: boolean) => `${displayMode ? "display" : "inline"}\u0000${latex}`;
...
export const MathHtml = memo(function MathHtml({
  ...
  const mathClassName = `${displayMode ? "kice-math-display" : "kice-math-inline"} ${className}`.trim();
